...
const TABS: TabSection[] = [
        ...
        items: [
            {
                ...
                url: '/parameters/sites-environment?tab=sites',
                status: 'configured',
            },
            {
                id: 'env-conditions',
                ...
                icon: IconCloudRain,
                url: '/parameters/sites-environment?tab=conditions',
                status: 'configured',
            },
            {
                id: 'audit-area',
                ...
                url: '/parameters/sites-environment?tab=audit-areas',
                status: 'configured',
            },
            {
                id: 'work-area',
                ...
                icon: IconMapPin,
                url: '/parameters/sites-environment?tab=work-areas',
                status: 'configured',
            },
            {
                id: 'work-process',
                ...
                icon: IconGitBranch,
                url: '/parameters/sites-environment?tab=work-processes',
                status: 'configured',
            },
        ],
    },
        ...
        items: [
            {
                ...
                icon: IconUsers,
                url: '/parameters/incidents?tab=teams',
                status: 'configured',
            },
            {
                id: 'departments',
        ...
        items: [
            {
                ...
                icon: IconCategory,
                url: '/parameters/incidents?tab=categories',
                status: 'configured',
            },
            {
                id: 'incident-type',
                ...
                icon: IconList,
                url: '/parameters/incidents?tab=types',
                status: 'configured',
            },
            {
                id: 'severity-level',
                ...
                url: '/parameters/incidents?tab=severity',
                status: 'configured',
            },
            {
                id: 'body-parts',
                ...
                icon: IconBodyScan,
                url: '/parameters/incidents?tab=body-parts',
                status: 'configured',
            },
        ],
    },
    {
        ...
        shortLabel: 'Outils',
        description: "Modèles d'inspection, check-lists, vivier d'auditeurs et mesures techniques.",
        icon: IconTools,
        color: 'violet',
        items: [
            {
                id: 'inspection-templates',
                name: "Modèles d'inspection",
                description: "Grilles d'inspection réutilisables et leurs points de contrôle, personnalisables à la planification",
                icon: IconClipboardCheck,
                url: '/parameters/tools-templates?tab=inspection-templates',
                status: 'configured',
            },
            {
                id: 'checklists',
                name: 'Check-lists',
                description: "Listes de vérification rattachées aux catégories d'événement",
                icon: IconList,
                url: '/parameters/tools-templates?tab=checklists',
                status: 'configured',
            },
            {
                id: 'auditors',
                name: 'Auditeurs internes',
                description: "Vivier d'auditeurs avec qualifications et domaines (ISO 19011 §7)",
                icon: IconUserCheck,
                url: '/parameters/tools-templates?tab=auditors',
                status: 'configured',
            },
            {
                id: 'measurements',
                name: 'Mesures techniques',
                description: 'Grandeurs, unités et seuils utilisés dans les relevés de surveillance',
                icon: IconDevicesCog,
                url: '/parameters/tools-templates?tab=measurements',
                status: 'configured',
            },
            {
                id: 'calibration',
