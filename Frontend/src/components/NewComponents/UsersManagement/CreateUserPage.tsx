...
const PREDEFINED_ROLES = [
    {
        ...
        defaultModules: [
            ...
            'complianceDashboard', 'regulatoryRegister', 'regulatoryLicenses', 'workAuthorizations',
            'mandatoryInspections', 'requirements', 'positionAssignments', 'employeeAssignments',
...
const MODULE_CATEGORIES: ModuleCategory[] = [
    ...
    { key: 'compliance', color: 'green', modules: ['complianceDashboard', 'regulatoryRegister', 'regulatoryLicenses', 'workAuthorizations', 'mandatoryInspections', 'requirements', 'positionAssignments', 'employeeAssignments'] },
