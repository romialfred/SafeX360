...
const NewAuditPlans: React.FC = () => {
    ...
    const handleSubmit = () => {
        ...
        modals.openConfirmModal({
            title: <span className="text-lg">Confirmer la création de l'audit</span>,
            centered: true,
            children: (
                <span className="text-sm">
                    Souhaitez-vous créer ce plan d'audit ? Vérifiez que vous avez bien renseigné tous les détails (auditeurs, périmètre, processus).
                </span>
            ),
            ...
            onConfirm: () => {
                ...
                createAudit(values)
                    .then(() => {
                        successNotification("Plan d'audit créé avec succès");
            ...
            <section className="bg-white rounded-lg border border-slate-200 overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <TextInput size="sm" disabled {...form.getInputProps("audit.refNumber")} label="Référence (auto)" placeholder="Générée automatiquement" />
    ...
    const renderAuditorItem = (_item: ListItem, index: number) => (
        <div key={index} className="flex flex-col gap-2" >
            <Fieldset key={index} className="grid grid-cols-1 md:grid-cols-3 gap-3"
                ...
                <ActionIcon size="xs" onClick={() => form.removeListItem("auditors", index)} variant="light" color="red" aria-label="Retirer">
                ...
                return (
                    <div className="space-y-4">
                        ...
                        <section className="bg-white rounded-lg border border-slate-200 overflow-hidden">
                            ...
                            <div className="p-4 space-y-3">
                                <Radio.Group size="sm" {...form.getInputProps("audit.category")} label="Modalité d'audit" withAsterisk>
                                    <Group mt="xs">
        ...
        <div className="p-5 space-y-5 max-w-[1600px] mx-auto">
            <PageHeader
                breadcrumbs={[
                    ...
                    { label: "Nouveau plan d'audit" },
                ]}
                icon={<IconClipboardCheck size={22} stroke={2} />}
                iconColor="indigo"
                title="Nouveau plan d'audit"
                subtitle="Programmation conformément à ISO 19011 — Lignes directrices pour l'audit"
                badge={
            ...
            <FormWithHelp
                ...
                helpItems={[
                    ...
                    { key: 'category', icon: IconCertificate, iconColor: 'violet',
                        title: "Modalité",
                        content: "Interne (1ère partie), fournisseur (2ème partie) ou certification (3ème partie). Exigences de compétence et indépendance distinctes.",
                ...
                helpTip="Vous pouvez sauvegarder en brouillon entre les étapes. Le numéro de référence sera attribué à l'enregistrement définitif."
            >
