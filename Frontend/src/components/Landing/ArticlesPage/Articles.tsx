        ...
        <div className="flex gap-10 p-10">
            <div className="flex flex-col gap-10 w-1/2 p-2">
                <div className="flex flex-col gap-3">
                    <p className="text-2xl text-primary">Recent Reads</p>
                    <p className="text-4xl">Articles & blog posts with useful information</p>
                </div>
                <div className="flex flex-col gap-6 bg-gray-100 p-8  shadow-md">
                    ...
                    <div>
                        <h1 className="text-4xl leading-tight">Top Manufacturing Trends Shaping Industry’s Future</h1>
                    </div>
                    <div>
            ...
            <div className="p-10  w-1/2 flex flex-col gap-20 ">
                <div className="flex justify-end">
                    <Button className="text-primary">View All Articles</Button>
                </div>
