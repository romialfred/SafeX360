        ...
        <div className="flex relative">
            ...
            <div className="flex flex-col gap-5 w-1/2 relative">
                <div className="p-10 flex flex-col gap-4">
                    <p className="text-primary text-2xl font-medium">Core Values</p>
                    <h1 className="text-4xl font-medium">Trusted Global Partner for Manufacturing and Construction</h1>
                ...
                <div className="flex">
                    ...
                    <div className="absolute right-174 p-10 flex flex-col items-center text-white shadow-lg bg-gray-500/50 backdrop-blur-md rounded-tl-sm w-[310px] h-[244px]">
                        <p className="text-9xl font-bold text-primary">25</p>
