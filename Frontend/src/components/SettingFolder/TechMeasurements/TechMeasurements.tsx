        ...
        <div className=' '>
            <div className="flex justify-between items-center  ">
                <div>
                    ...
                    <div className="text-2xl font-semibold text-slate-900 bg-gradient-to-r from-primary to-secondary bg-clip-text ">Technical Measurements</div>
                    <Breadcrumbs className="" mt="xs">
                        ...
                        <Text c="teal" fw={500}>Technical Measurements</Text>
                    </Breadcrumbs>
                </div>
