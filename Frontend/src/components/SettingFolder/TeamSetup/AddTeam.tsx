...
const AddTeam = () => {
    ...
    const handleSubmit = () => {
        ...
        createIncidentTeam(form.values).then((_res) => {
            successNotification("Équipe créée avec succès");
            navigate("/team-setup");
        }).catch((err) => {
        ...
        <div className="flex flex-col gap-5">
            <div className="flex justify-between items-center  ">
                <div>
                    ...
                    <div className="text-2xl font-semibold text-slate-900 bg-gradient-to-r from-primary to-secondary bg-clip-text ">Nouvelle équipe</div>
                    <Breadcrumbs className="" mt="xs">
                        ...
                        <Text c="teal" fw={500}>Nouvelle équipe</Text>
                    </Breadcrumbs>
                </div>
