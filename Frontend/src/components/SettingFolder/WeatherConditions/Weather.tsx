        ...
        <div className=' '>
            <div className="flex justify-between items-center  ">
                <div>
                    ...
                    <div className="text-2xl font-semibold text-slate-900 bg-gradient-to-r from-primary to-secondary bg-clip-text "> Environmental Conditions</div>
                    <Breadcrumbs className="" mt="xs">
                        ...
                        <Text c="teal" fw={500}> Environmental Conditions</Text>
                    </Breadcrumbs>
                </div>
