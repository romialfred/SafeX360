    ...
    return (
        <div className=' '>
            <div className="flex justify-between items-center  ">
                <div>
                    <div className="text-2xl font-semibold text-blue-500 bg-gradient-to-r from-primary to-secondary bg-clip-text ">Audit Area</div>
                    <Breadcrumbs className="" mt="xs">
                        ...
                        <Text variant="gradient">Audit Area</Text>
                    </Breadcrumbs>
                </div>
