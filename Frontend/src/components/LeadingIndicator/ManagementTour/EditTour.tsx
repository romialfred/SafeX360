...
const EditTour = () => {
    ...
    const handleSubmit = (values: any) => {
        ...
        updateActivity(values).then((_res) => {
            successNotification("Tour updated successfully");
        ...
        <div className="">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <div className="text-2xl text-slate-900 w-fit">Update Leadership Walk</div>
                    <Breadcrumbs mt="xs" mb="lg">
                        {/* LOT 40 P1: breadcrumbs Mantine 7 — couleurs sémantiques au lieu de variant="gradient" */}
                        <Link className="hover:!underline" to="/">
                            <Text c="dimmed">Home</Text>
                        </Link>
                        <Link className="hover:!underline" to="/steering-tours">
                            <Text c="dimmed">Leadership Walk</Text>
                        </Link>
                        <Text c="teal" fw={500}>Update Leadership Walk</Text>
                    </Breadcrumbs>
                </div>
            </div>
            ...
            <form onSubmit={form.onSubmit(handleSubmit)}>
                <div className="flex flex-col gap-8">
                    ...
                    <Fieldset
                        ...
                        legend={<div className="text-lg text-teal-700">Tour Informations</div>} >
                        <Select withAsterisk disabled label="Activity" placeholder="Select activity" data={activities} {...form.getInputProps('activityId')} />
                ...
                <div className="flex gap-2 mt-8 justify-end">
                    ...
                    <Button type="submit" variant="gradient" disabled={isLocked}>Update Tour</Button>
                </div>
            </form>
        </div>
    )
