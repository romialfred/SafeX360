        ...
        <Card className="bg-white border border-slate-200 shadow-sm rounded-xl p-6">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Analysis Method</Text>
                    ...
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Origin</Text>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Individual Factors</Text>
                        <Text className="text-slate-600">{showValue(analysis?.individualFactors)}</Text>
                    </div>
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Technical Factors</Text>
                        <Text className="text-slate-600">{showValue(analysis?.technicalFactors)}</Text>
                    </div>
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Organizational Factors</Text>
                ...
                {/* Root Causes */}
                <div>
                    <Text size="sm" className="text-slate-700 mb-2">Root Causes</Text>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Start Date</Text>
                        <Text className="text-slate-600">{analysis?.startDate ? formatDateShort(analysis.startDate) : '-'}</Text>
                    </div>
                    <div>
                        <Text size="sm" className="text-slate-700 mb-2">Deadline</Text>
