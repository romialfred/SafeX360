    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <Card shadow="sm" radius="md" withBorder className=" !p-6 bg-white space-y-6">
                <h2 className="text-2xl font-semibold flex gap-5 items-center text-primary"> {inspection.title} <Tag severity={getSeverity(inspection.status)} value={inspection.status} /></h2>
                ...
                <div className="grid grid-cols-2 gap-4  text-gray-700">
                    ...
                    <div>
                        <p className="text-xl" > Planned Date</p>
              ...
              <li>Assess ventilation systems</li>
                ...
                <div>
                    <p className="text-xl"> Risk Types</p>
                ...
                <div>
                    <p className="text-xl mb-4"> Inspectors</p>
                ...
                <div>
                    <p className="text-xl mb-5"> Required PPE</p>
                    <div className="flex flex-wrap gap-2">
                        {inspection.ppe?.map((x: any, index: any) => (
                            <div
                                key={index}
                                className="inline-flex items-center px-4 py-2 rounded-full bg-orange-100 text-orange-800 text-sm shadow-sm hover:bg-orange-200 transition"
                            >
                                {x}
                            </div>
                        ))}
