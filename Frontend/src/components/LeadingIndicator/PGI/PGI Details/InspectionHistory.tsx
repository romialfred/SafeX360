...
import { actionStatusesMap, auditStatusMap } from '../../../../Data/DropdownData';
                        ...
                        <Timeline.Item key={entry.id} title={auditStatusMap[entry.status]}>
                            <Card shadow="sm" radius="md" className="bg-white mt-2" withBorder>
                                <Group justify="space-between" className="mb-2">
                                    ...
                                    <Badge color="gray" variant="light" className='!capitalize'>{actionStatusesMap[entry.status]}</Badge>
                                </Group>
