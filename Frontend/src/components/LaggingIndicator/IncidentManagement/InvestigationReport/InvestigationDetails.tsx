    ...
    return (
        <div className="p-5 mt-3 border rounded-lg border-gray-300 shadow-md flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
                <h2 className="text-xl font-semibold text-gray-800 ">Method</h2>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {(form.values.startDate && form.values.endDate) && <div className="bg-green-50 border-green-500 border rounded-xl shadow-sm p-3">
                        <p className="text-sm font-bold text-green-700">Investigation Duration: <span className=" font-medium text-green-700"> {getDateDifferenceInDays(form.values.startDate, form.values.endDate)} days</span></p></div>}
                </div>
