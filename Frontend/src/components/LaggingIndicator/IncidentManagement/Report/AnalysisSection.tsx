                ...
                <Accordion.Item value="investigation">
                    ...
                    <Accordion.Panel>
                        <div className="p-4 space-y-4">
                            ...
                            <ImageDropzone form={form} id="supportingEvidence" title="Supporting Evidence" />
                        </div>
                    </Accordion.Panel>
                </Accordion.Item>
                ...
                <Accordion.Item value="actionPlans">
                    ...
                    <Accordion.Panel>
                        <div className="flex flex-col p-5 gap-5">
                            ...
                            {form?.values.correctiveActions && form?.values.correctiveActions.map((_x: any, index: any) => <Fieldset className="grid grid-cols-2 gap-6" legend={<div className="flex gap-5">
                                <div className="text-lg font-medium text-blue-500">Action {index + 1}</div>
                                <ActionIcon onClick={() => form.removeListItem('correctiveActions', index)} variant="filled" color="red" aria-label="Settings">
