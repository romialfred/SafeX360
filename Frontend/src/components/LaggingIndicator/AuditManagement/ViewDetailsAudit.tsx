    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center">
                <div>
                    <div className="font-semibold text-2xl text-blue-500 w-fit">Audit Details</div>
            ...
            <Card withBorder shadow="md" radius="md" p="lg">
                <div className='flex justify-between items-center '>
                    <div className='flex flex-col gap-4'>
                        <h1 className='text-2xl font-medium'>{audit.title}</h1>
                    ...
                    <div className=' bg-amber-400 p-2 rounded-4xl '>
                        <p className='text-amber-800 font-medium flex gap-2 items-center'><IconClock /> {capitalizeFirstLetter(audit.status)}</p>
                    </div>
                </div>
                ...
                <Divider my="sm" />
                <div className='flex flex-col gap-4'>
                    <p className='text-xl font-medium'>Purpose & Objectives</p>
                ...
                <div className='mt-5 '>
                    <p className="font-medium mb-2  text-xl">Audit Types</p>
                ...
                <div>
                    <p className='text-xl font-medium mt-5 mb-2'>Audit Team {audit.category == "EXTERNAL" && auditors.length > 0 && <span className='text-primary text-base'>({auditors.length > 0 && auditors[0].company})</span>}</p>
                ...
                <div className='mt-5'>
                    <p className="font-medium  text-xl mb-4"> Committee Member</p>
                    <div className="grid grid-cols-4 gap-5">
                ...
                <div className='mt-5'>
                    <p className="font-medium  text-xl mb-4">Audit Areas</p>
