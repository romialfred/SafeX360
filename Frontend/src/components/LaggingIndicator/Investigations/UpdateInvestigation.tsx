        ...
        <div className='flex self-start flex-col col-span-2 gap-3 shadow-sm p-5 rounded-md border border-gray-200'>
            ...
            <div className="mb-5">
              <div className="rounded-lg border border-blue-100 bg-blue-50 px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm text-blue-900">Investigation Details</p>
          ...
          {cannotUpdate ? (
            <Card shadow="xs" padding="md" radius="md" withBorder className={`${isCompleted ? 'bg-green-50 border-green-200' : isCancelled ? 'bg-red-50 border-red-200' : 'bg-yellow-50 border-yellow-200'}`}>
              {isCompleted && (<Text c="green">This investigation is already completed. Further updates are not allowed.</Text>)}
              {isPending && (<Text c="yellow">This investigation is pending approval. Updates are not allowed until it is approved.</Text>)}
              {isCancelled && (<Text c="red">This investigation has been cancelled. Further updates are not allowed.</Text>)}
            </Card>
          ) : (
