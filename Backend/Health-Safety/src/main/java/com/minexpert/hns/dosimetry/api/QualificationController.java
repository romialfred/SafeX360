...
import com.minexpert.hns.dosimetry.service.QualificationService;
import com.minexpert.hns.dto.ResponseDTO;

import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/dosimetry/qualification")
@CrossOrigin
...
public class QualificationController {
    ...
    public ResponseEntity<Long> create(@RequestParam("companyId") Long companyId,
            @RequestBody QualificationDTO dto) {
    ...
    public ResponseEntity<ResponseDTO> update(@RequestParam("companyId") Long companyId,
        ...
        return new ResponseEntity<>(new ResponseDTO("Qualification updated successfully"), HttpStatus.OK);
    }

    @GetMapping("/getAll")
    public ResponseEntity<List<QualificationDTO>> getAll(@RequestParam("companyId") Long companyId) {
    ...
    public ResponseEntity<ResponseDTO> delete(@PathVariable Long id) {
        service.delete(id);
        return new ResponseEntity<>(new ResponseDTO("Qualification deleted successfully"), HttpStatus.OK);
    }
}
