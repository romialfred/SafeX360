...
public class NonConformityDTO {
    ...
    public NonConformity toEntity() {
        return new NonConformity(id, type, number, title, date, detectionDate, reportedBy,
                ...
                null, requirement,
                detectionSource, actionTaken, severityLevel, nearMissType, factors.toString(), improvement,
                events.toString(), preventiveAction, currency,
                materialCost,
                laborCost, adminFees, expenses,
                details, null, indirectImpacts.toString(), comments, supportComments,
